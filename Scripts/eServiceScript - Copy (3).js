...
$(document).ready(function () {
    ...
    $(".passport").keydown(function (event) {

        var k = event.keyCode;
        var ckeck  = ((k > 64 && k < 91) || (k > 96 && k < 123) || k == 8 || k == 32 || (k >= 48 && k <= 57));
        return ckeck;
    });
    ...
    $(".numeric").keydown(function (event) {
        ...
        var ret = ((keyCode >= 48 && keyCode <= 57) || keyCode == 8 || keyCode == 46 );
        return ret;
    }
    );
    ...
    //        var ckeckChars = /[^0-9]/gi;
    //        console.log(event.target.value);
    //        console.log(checkChars.test(event.target.value));
    //        return checkChars.test(event.target.value);
    ...
    //$(".letters").keydown(function (event) {

    //    var keyCode = event.which ? event.which : event.keyCode

    //    var ret = (keyCode > 47 && keyCode < 58 || keyCode > 95 && keyCode < 107);
    //    return ret;
    //}
    //);
