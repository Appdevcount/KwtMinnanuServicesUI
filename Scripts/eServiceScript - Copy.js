...
var applicationUrl = 'http://10.10.26.226/eService/';
...
$(document).ready(function () {
    ...
    $('#SubmitRequest').click(function (e) {
        ...
        var mySelectedDateForCivilID = new Date($('#txtCivilIdExpirydatePickerhdn').val());
        var MySelecteddateForTradeLicense = new Date($('#txtTradeLicenseExpiryDatePickerhdn').val());
        var today = new Date();
        if (mySelectedDateForPassport < today) {
            alert('NewDateShouldBeGreaterthanTodays');
            e.preventDefault();
        }
...
if (page_name.indexOf("BrokerRenewal/BrokerUpdate") != -1 || page_name.indexOf("ClearingAgentExamRequest") != -1) {
    ...
    function up(pageName) {
        ...
        // 'http://localhost/API/api/Docs/Upload';
        ...
        $.ajax({
            ...
            success: function (responseData) {
               ...
               //     var deleteStr = '/'+'/eservice' + pageName + '/DeleteFile?dataItem=aa';
                 ...
                 //   var downloadStr = '/' + '/eservice' + pageName + '/DownloadFile?filename=aa';
                ...
                //    window.location.reload();
                    ...
                    filesTable.row.add
                        ([
                            ...
                            "<td>" + today + "</td>",
                            "<td >" + "<a class='btn btn-primary' href=" + resDownload + ">" + downloadString + "</a> </td>",
                            "<td >" + "<a class='btn btn-primary' href=" + resDelete + ">" + deleteString + "</a> </td>"
