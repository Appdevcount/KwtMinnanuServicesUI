...

{
    public class BrokerRenewalController : MyBaseController
    {
        ...
        public ActionResult DeleteFile(string dataItem)
        {
            ...
            {
                WriteToLogFile("Exception " + ex.Message + " " + dataItem.ToString() + Session["MicroClearUser"].ToString() + Session["EserviceRequestid"].ToString(), " public ActionResult DeleteFile(string dataItem)");
            }
