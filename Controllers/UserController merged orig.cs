...
namespace WebApplication1.Controllers
{
    public class UserController : MyBaseController
    {
        ...
        public ActionResult OrganizationDocuments(string OrgId, string OrgReqId, string OrgName)
        {
            ...
            try
            {
                Od = GetOrganizationDocumentDetails(OrgId,  OrgReqId,  OrgName);
        ...
        public OrganizationDocument GetOrganizationDocumentDetails(string OrgId, string OrgReqId, string OrgName)
        {
            OrganizationDocument Od = new OrganizationDocument();
            ...
            Od.OrgReqId= CommonFunctions.CsUploadDecrypt(encrypt.Decode(OrgReqId));
            ...
            {
                Text = "Please select a License Type",
                Value = "UnSelected"//"18"
            });
            LicenceTypeList.Add(new SelectListItem
            {
