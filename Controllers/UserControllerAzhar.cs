    ...
    public class UserController : MyBaseController
    {
...

        {
            try
            {
                ...
                Session["azharTest"] = ObjOrgGetBasicResult.OrganizationRequestId;
            ...
            try
            {
                ...
                if (TempData["data"] != null)
                {
                    ...
                    if (Session["purpose"].ToString().Trim() == Constantclass.number1)
                    {
                            ...
                            //need to check how its not null in noneditable view
                        {
                           ...
                           Session["azharTest"] = objOrgRequestdatalist[0].Data.OrgGetBasicResult[0].OrganizationRequestId;
                        }
                        else
                        {
                            Session["azharTest"] = objOrgRequestdatalist[0].Data.OrgGetBasicResult[0].OrganizationRequestId;
                ...
                if (res == Constantclass.number || Session["purpose"].ToString().Trim() != Constantclass.number1)
                {
                    ...
                    //    List<OrgGetBasicResult> objlist = new List<OrgGetBasicResult>();
                        ...
                        objOrgreg.mUserid = Session["UserId"].ToString();
                        objOrgreg.tokenId = Session["TokenId"].ToString();
                        objOrgreg.OrganizationId = Session["azharTest"].ToString();
                        objOrgreg.sOrgReqId = Session["azharTest"].ToString();
                        ...
                        if (objOrgRequestdatalist[0].Data.OrgGetBasicResult != null)
                        {
                            ...
                            {
                                //changes for test by azhar

                                WriteToLogFile("checkbeforeindustrial", "535");

                               // objOrgRequestdatalist[0].Data.OrgGetBasicResult[0].isIndustrial = true;

                                if (objOrgRequestdatalist[0].Data.OrgGetBasicResult[0].isIndustrial != false)
                                { 

                                WriteToLogFile(objOrgRequestdatalist[0].Data.OrgGetBasicResult[0].isIndustrial.ToString(), "checkvalueforindustrail");
                                }
                                else
                                {
                                ...
                                {
                                    WriteToLogFile("insideIndustrial", "544");
                                ...
                                {
                                    WriteToLogFile("checkelseofindustrial", "544");
